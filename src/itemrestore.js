...
import { inferGradeFromCartItemName } from './cart.js';
import { SERVERS } from './data/servers.js';
import { makeSelect, renderSelectedItems } from './components/select.js';
import { appendReloadBtn } from './components/reload-btn.js';
 ...
 */
export const showItemRestorePopup = ({ title, body, buttons }) => {
 ...
 */
export const buildItemRestoreUI = (container, grades, info, items, { makeItemIconLink }) => {
    // --- State ---
...
export const initItemRestore = ({ injectItemIconStyles, injectSelectedItemsStyles, makeItemIconLink }) => {
