...
(() => {
  ...
  // src/components/serverClock/serverClock.js
  ...
  let getItemCodexUrl2 = /* @__PURE__ */ __name((item) => `${CODEX_ITEM_URL}${item.id}/${item.isGradeInferred ? `?grade=${item.grade}` : ""}`, "getItemCodexUrl");
  ...
  // src/components/reloadBtn/reloadBtn.js
  ...
  // src/pages/itemRestore/itemRestore.js
  let IR_URL = {
  ...
  let loadAllQuestHistory = /* @__PURE__ */ __name(() => {
    try {
      return JSON.parse(localStorage.getItem(LS_KEYS2.QUEST_HISTORY)) || {};
    } catch {
      return {};
    }
  }, "loadAllQuestHistory");
  ...
  // scss:/Users/cergx/wsProjects/archeage-extra-ui/src/pages/marathon/selectedItems/selectedItems.scss
  ...
  // scss:/Users/cergx/wsProjects/archeage-extra-ui/src/pages/marathon/page/page.scss
  ...
  let makeItemIconLink = /* @__PURE__ */ __name(({ item, linked = false, size = "medium", count, noTooltip = false }) => {
    ...
    if (linked) {
      icon.href = getItemCodexUrl2(item);
      icon.target = "_blank";
  ...
  // src/components/itemIcon/itemIcon.js
